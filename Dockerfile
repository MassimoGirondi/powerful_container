...
RUN apt -y install python3 pkg-config libnl-3-dev libnl-route-3-dev python3-setuptools libtinfo-dev libedit-dev libxml2-dev python3-pip libboost-all-dev libgoogle-glog-dev
RUN apt -y install xauth xterm
RUN pip3 install matplotlib pandas

# RDMA basic libraries
